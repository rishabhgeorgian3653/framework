...
public class ShdPoolWindows extends TestBase{
	...
	public ShdPoolWindows() throws IOException {
		PageFactory.initElements(driver, this);
	}
	
	
	/*
	 * function for adding windows shared hosted desktop pool
	 * 
	...
	public void addingSHDpool() throws IOException, InterruptedException {
				...
				pool.click();
				addnewpool.click();
				poolname.sendKeys(prop.getProperty("poolname"));
				displayname.click();
				userbased.click();	
	...
	/* 
	 * function to extract text from display name of shd pool
	 * 
	 */
