...
import com.qa.pages.ShdPoolWindows;

public class ShdpoolWindowsTest extends TestBase{
	
	ShdPoolWindows shdpool;
	LoginPage loginpage;

	public ShdpoolWindowsTest() throws IOException {
		super();
	...
	@Test
	public void isWindowShdPoolGenerated() throws IOException, InterruptedException
	{
			...
			Assert.assertEquals(poolstatus, prop.getProperty("poolname"));
